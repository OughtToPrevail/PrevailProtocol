...
/**
 * Thrown when a user requests to add devices which with the current amount of devices pass the {@link Settings#getMaxDevices()}.
 */
public class TooManyDevicesException extends Exception
{
	/**
	 * Constructs a new {@link TooManyDevicesException} with the specified detail message.
	 *
